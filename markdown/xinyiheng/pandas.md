- pandas（http://pandas.pyda ta.org）提供了高级数据结构和函数，这些数据结构和函数的设计使得利用结构化、表格化数据的工作快速、简单、有表现力。它出现于2010年，帮助Python成为强大、高效的数据分析环境。在本书中主要使用的pandas对象是[[DataFrame]]，它是用于实现表格化、[[面向列]]、使用[[行列标签]]的数据结构；以及[[Series]]，一种[[一维标签数组]]对象。
