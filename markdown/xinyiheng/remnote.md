...
- remnote的graph图像是用圆圈取代了方框的思维导图，它做的好的地方就是每个节点是展开还是收缩都悄无痕迹，让我一度没有看出它就是思维导图，还以为是概念图。它对我的启发是，只要the brain中的thought可以在不需要的时候收敛在某个节点一下，多放一些thought也不会overwhelming。#[[洞见]]#[[可视化]]
